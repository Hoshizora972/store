...
<body>
    ...
    <div class="h-screen bg-orange-50 pt-20">
    ...
    <div class="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
      ...
      <div class="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
        ...
        {{-- <button href="{{route('commande.create')}}" class="mt-6 w-full rounded-md bg-rose-800 py-1.5 font-medium text-white hover:bg-rose-900">Check out</button> --}}
       <a href="{{route('commande.create')}}" class="mt-6 flex w-full items-center justify-center rounded-md border border-transparent bg-pink-700 px-8 py-3 text-base font-medium text-white hover:bg-pink-900 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2">Check out</a>
    </div>
