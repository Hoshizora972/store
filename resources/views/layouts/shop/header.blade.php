    ...
    <div class="container relative">
            ...
            <li class="dropdown inline-block relative ps-0.5">
                ...
                <div class="dropdown-menu absolute end-0 m-0 mt-4 z-10 w-48 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 hidden" onclick="event.stopPropagation();">
                    <ul class="py-2 text-start">
                        ...
                        <li>
                            <a href="{{route('dashboard')}}" class="flex items-center font-medium py-2 px-4 dark:text-white/70 hover:text-orange-500 dark:hover:text-white"><i data-feather="user" class="h-4 w-4 me-2"></i>My Account</a>
                        </li>
                        {{-- <li>
        ...
        <div id="navigation">
            ...
            <ul class="navigation-menu">
                <li><a href="{{route('product')}}" class="sub-menu-item">Home</a></li>
